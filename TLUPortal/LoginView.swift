...
//    @StateObject var login_vars = TLUPortalPublishedVariables()
    @EnvironmentObject var login_vars: TLUPortalPublishedVariables
    ...
    var body: some View {
            ...
            LoadingView(isShowing: $isLoadingShow) {
                ZStack {
                    ...
                    VStack {
                        ...
                        Button(action: {}) {
                            NavigationLink(destination: PDFUIViewer(title_name: "User Manual", document_name: "UserGuide").environmentObject(login_vars)) {
                                Text("USER MANUAL")
                                    .frame(minWidth: 0, maxWidth: .infinity)
                                    .font(.system(size: 18))
                                    .fontWeight(.bold)
                                    ...
                                    .foregroundColor(Color.white)
                                    .background(
                                        RoundedRectangle(cornerRadius: 20, style: .continuous).stroke(Color.white, lineWidth: 1)
                                    ).padding(16)
        ...
        .navigate(to: CustomTabView().environmentObject(login_vars),
                  when: $done)
    } // End of content view
}
